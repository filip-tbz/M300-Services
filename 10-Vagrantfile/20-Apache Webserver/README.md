...
Zuerst müssen wir ins Verzeichnis wechseln und danach die VM starten:
            ...
            $ cd Documents/M300_personal/MeinLokalesRepository/M300-Services/10-Vagrantfile/20-Apache Webserver/

Danach muss die VM vie `vagrant up` gestartet werden:

            AzureAD+ShagithijanBaasgaran@DESKTOP-B2E99P6 MINGW64 ~/Documents/M300_personal/MeinLokalesRepository/M300-Services/10-Vagrantfile/20-Apache Webserver (master)
            $ vagrant up 
